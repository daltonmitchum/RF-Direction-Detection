...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'C:\\Users\\patel\\Desktop\\CS 491\\print_test2.dat', False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_deinterleave_0, 0))
